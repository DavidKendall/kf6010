...
>    ```
     Assuming you are in the `kf610` directory and `blinky-bare` is now a
...
1. Build The program in the blinky-bare directory.
     ```
     $ cd blinky-mbed
...
1. **DigitalOut - LCD, AnalogIn - potentiometers** <br/>
   ...
   [Analogin API](https://os.mbed.com/docs/mbed-os/v5.14/apis/analogin.html) for information
