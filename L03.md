...
>    ```
   ...
   For the Lab machines.  Use the following:
>   If at some stage you get errors about permissions, then you may have to
...
1. **DigitalOut - RGB LED** <br/>
   ...
   board. (`Solution.01`)
	...
	[DigitalOut](https://os.mbed.com/docs/mbed-os/v5.14/apis/digitalout.html) may
	be useful for setting initial conditions.

   Branch `Solution.01` has a sample solution
