...
1. Follow the installation instructions at https://github.com/mbedmicro/pyOCD#installation.

1. Plug your FRDM-K64F into a USB port on your computer and run the command
...
1. If you didn't get any output at the previous step, that's probably because
   ...
   by adding a `udev` rule like this
